...
def get_data():
  ...
  with connection:
      ...
      with connection.cursor() as cursor:
          ...
          cursor.execute("SELECT DISTINCT page_tags.tag, page_information.id_page, page_information.content_article FROM `page_tags` INNER JOIN page_information ON page_tags.page_id = page_information.id_page")
